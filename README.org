...
- [X] P0.2 subprocess launch plumbing (=pkg/server=) + fake-server integration test
- [ ] P0.2 pyright reference server: real launch, initialize, pull diagnostics
  (needs =pyright-langserver= installed — =npm i -g pyright=)
